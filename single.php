...
if(class_exists('Redux')){
    $page_title_text = daneshyar_settings('single_post_sidebar_position');
    $enable_author = daneshyar_settings('article_author');
    $enable_related_post = daneshyar_settings('blog_related');
    $enable_post_thumbnail = daneshyar_settings('blog_featured_img');
    $enable_social_share = daneshyar_settings('blog_share_story');
}
?>
