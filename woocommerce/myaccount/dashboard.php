...
if ( class_exists( 'Redux' ) ) {
 	$instagram_link = daneshyar_settings('instagram_link');
	$telegram_link = daneshyar_settings('telegram_link');
    $youtube_link = daneshyar_settings('youtube_link');
    $aparat_link = daneshyar_settings('aparat_link');
 }
