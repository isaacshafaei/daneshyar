...
if(class_exists('Redux')){
    $after_bought_text =  daneshyar_settings('course_single_sidebar_position');
    $content_review_rules =  daneshyar_settings('content_review_rules');
    $course_detail_reviews =  daneshyar_settings('course_detail_reviews');
    $related_courses_display =  daneshyar_settings('related_courses_display');
    $course_advice =  daneshyar_settings('course_advice');
}
?>
