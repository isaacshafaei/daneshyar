...
if(class_exists('Redux')){
    $after_bought_text =  daneshyar_settings('course_student_text');
    $course_downloads =  daneshyar_settings('course_downloads');
    $course_students =  daneshyar_settings('course_students');
    $course_counters =  daneshyar_settings('course_counters');
    $course_share_story =  daneshyar_settings('course_share_story');
}
