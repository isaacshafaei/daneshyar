...
if(class_exists('Redux')){
    ...
    $garanty_text =  daneshyar_settings('garanty_text');
    $garanty_link =  daneshyar_settings('garanty_link');
    $vip_text =  daneshyar_settings('vip_text');
    $link_text =  daneshyar_settings('link_text');
    $vip_link =  daneshyar_settings('vip_link');
}
?>
