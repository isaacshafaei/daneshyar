...
if(class_exists('Redux')){
    ...
    if($button_link=='custom_link'){
        $after_text_button = (daneshyar_settings('custom_button_text_after_login'))?daneshyar_settings('custom_button_text_after_login'):'ورود و ثبت نام';
        $after_link_button = (daneshyar_settings('custom_button_link_after_login'))?daneshyar_settings('custom_button_link_after_login'):'#';
    }
}
if($button_link=='custom_link'){ ?>
