...
function faneshyar_metaboxes(){
    ...
    if(class_exists('Redux')){
        $choose_product_page =  daneshyar_settings('choose_product_page');
    }

    $perfix = 'daneshyar_';
    $textdomain = 'daneshyar';

        /**
     * Initiate the metabox
     */
    $daneshyar_matabox = new_cmb2_box( array(
        ...
        'tabs'=> array(
            array(
                ...
                'fields'=> array(
                    ...
                    $perfix.'disable_footer_widget',
                    $perfix.'disable_sub_footer',
    ...
    $daneshyar_matabox->add_field( array(
    ...
    $daneshyar_matabox->add_field( array(
        'name'       => __( 'غیرفعال کردن ابزارک های فوتر', $textdomain ),
        'id'         => $perfix.'disable_footer_widget',
        'type'       => 'checkbox',
    ) );
    $daneshyar_matabox->add_field( array(
        'name'       => __( 'غیرفعال کردن فوتر فرعی', $textdomain ),
        'id'         => $perfix.'disable_sub_footer',
        'type'       => 'checkbox',
    ) );
    $daneshyar_matabox->add_field( array(
    ...
    $daneshyar_matabox->add_field( array(
        'name'       => __( 'غیرفعال کردن هدر', $textdomain ),
        'id'         => $perfix.'disable_header',
        'type'       => 'checkbox',
    ) );
    ...
    $group_field_download = $daneshyar_matabox->add_field( array(
    ...
    $daneshyar_matabox->add_group_field( $group_field_download, array(
    ...
    if($choose_product_page=='ostad'){
        ...
        $courses_metaboxes->add_field( array(
            ...
            'type' => 'select',
            'options' => daneshyar_get_teachers_list()
        ) );
